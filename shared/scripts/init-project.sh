...
echo ""
echo "4. Create GitLab Deploy Token for Container Registry:"
...
echo ""
echo "5. Run infrastructure setup (Vault, ArgoCD, etc.):"
echo "   ./shared/scripts/setup-infrastructure.sh"
echo "   # Registry credentials will be stored in Vault automatically"
echo ""
echo "6. Configure service Vault secrets:"
echo "   ./shared/scripts/setup-vault-secrets.sh"
echo ""
echo "Note: Registry secrets (regsecret) are now managed via Vault + VSO."
echo "      VaultStaticSecret syncs to all namespaces automatically."
echo ""
