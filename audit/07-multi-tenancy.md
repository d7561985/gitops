...
│      └── ...                                                                 │
│                                                                              │
│  POLICIES (auto-generated by platform-bootstrap)                             │
│  ────────────────────────────────────────────                                │
│  ┌──────────────────────────────────────────────────────────────────────┐  │
│  │ Policy: poc-dev-read                                                   │  │
...
```yaml
# platform-bootstrap/templates/bootstrap-job.yaml
...
**Источник:** [`gitops-config/charts/platform-bootstrap/templates/bootstrap-job.yaml`](../gitops-config/charts/platform-bootstrap/templates/bootstrap-job.yaml)
...
```yaml
# Генерируется platform-bootstrap/templates/vault-auth.yaml
...
| **Автоматизация** | platform-bootstrap создаёт всё необходимое |
